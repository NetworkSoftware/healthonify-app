...
class MyHCSubscriptions extends StatelessWidget {
  MyHCSubscriptions({Key? key}) : super(key: key);

  bool noContent = false;

  Future<void> getWmSubs(BuildContext context, String id) async {
    noContent =
    await GetSubscription().getPhysioSubs(context, "userId=$id&isActive=true&flow=healthCare");
  }
