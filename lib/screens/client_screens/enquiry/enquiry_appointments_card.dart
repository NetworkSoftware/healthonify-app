...
import 'package:healthonify_mobile/screens/client_screens/enquiry/enquiry_list_screen.dart';
import 'package:provider/provider.dart';

class EnquiryMyAppoinmentsCard extends StatefulWidget {
  final Function onRequest;
  const EnquiryMyAppoinmentsCard({required this.onRequest, Key? key})
      : super(key: key);

  @override
  State<EnquiryMyAppoinmentsCard> createState() =>
      _EnquiryMyAppoinmentsCardState();
}

class _EnquiryMyAppoinmentsCardState extends State<EnquiryMyAppoinmentsCard> {
