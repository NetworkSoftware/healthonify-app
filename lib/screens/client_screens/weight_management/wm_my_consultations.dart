...
class WmMyConsultations extends StatefulWidget {
  const WmMyConsultations({Key? key}) : super(key: key);

  @override
  State<WmMyConsultations> createState() => _WmMyConsultationsState();
}

class _WmMyConsultationsState extends State<WmMyConsultations> {
                    ...
                    children: [
                      ...
                      RichText(
                        text: TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  text: consultationData.expertiseId![0]["name"],
                  ...
                  Column(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        radius: 36,
                        backgroundImage: consultationData.expert!.isEmpty ||
