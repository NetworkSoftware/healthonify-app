...
class _BodyFatScreenState extends State<BodyFatScreen> {
  ...
  Future<void> calulate(
    ...
    try {
      ...
      if (_showHips == true) {
        urlData =
            "weight=${bmiData.weight}&height=${bmiData.height}&age=${bmiData.age}&gender=${bmiData.gender}&neck=${bmiData.neck}&waist=${bmiData.waist}&tool=bfp&hip=${bmiData.hips}&userId=$userId";
      } else {
        urlData =
            "weight=${bmiData.weight}&height=${bmiData.height}&age=${bmiData.age}&gender=${bmiData.gender}&neck=${bmiData.neck}&waist=${bmiData.waist}&tool=bfp&userId=$userId";
      }
