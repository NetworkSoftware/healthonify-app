...
class PrescriptionExpertsScreen extends StatefulWidget {
  const PrescriptionExpertsScreen({
    Key? key,
  ...
  @override
  State<PrescriptionExpertsScreen> createState() => _PrescriptionExpertsScreenState();
}

class _PrescriptionExpertsScreenState extends State<PrescriptionExpertsScreen> {
  ...
  Future<void> getConsultations() async {
    ...
    try {
      await Provider.of<StorePrescriptionProvider>(context, listen: false)
          .getExpertPrescriptionAllData(userId,widget.userId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Consumer<StorePrescriptionProvider>(
          ...
          value.expertPrescriptionList.isEmpty ?
          const Center(
            child: Text('No Prescription Available'),
              ...
              shrinkWrap: true,
              itemCount: value.expertPrescriptionList.length,
              itemBuilder: (context, index) {
                return enquiryCard(context,value.expertPrescriptionList[index]);
              })),
    );
  }
