...
import "package:healthonify_mobile/screens/expert_screens/expert_session_schedule.dart";
...
class ExpertAppointmentViewSessionByEnquiry extends StatefulWidget {
  ExpertAppointmentViewSessionByEnquiry({Key? key, required this.ticketNumber,this.flow}) : super(key: key);
  String ticketNumber;
  String? flow;
  @override
  State<ExpertAppointmentViewSessionByEnquiry> createState() => _ExpertAppointmentViewSessionByEnquiryState();
}

class _ExpertAppointmentViewSessionByEnquiryState extends State<ExpertAppointmentViewSessionByEnquiry> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  consult.status == "waitingToSchedule" ?
                  Align(
                      ...
                      onTap: () async {
                       bool result = await Navigator.push(context,
                            MaterialPageRoute(builder: (context) {
                              return ExpertSessionSchedule(
                                ticketNumber: widget.ticketNumber,
                                sessionNumber: consult.sessionNumber!,
                              );
                            }));
