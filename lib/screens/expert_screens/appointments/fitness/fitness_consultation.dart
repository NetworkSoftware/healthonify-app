...
class FitnessConsultations extends StatefulWidget {
  const FitnessConsultations({Key? key})
      : super(key: key);

  @override
  State<FitnessConsultations> createState() =>
      _FitnessConsultationsState();
}

class _FitnessConsultationsState
    extends State<FitnessConsultations> {
