...
class LiveWellConsultations extends StatefulWidget {
  const LiveWellConsultations({Key? key})
      : super(key: key);

  @override
  State<LiveWellConsultations> createState() =>
      _LiveWellConsultationsState();
}

class _LiveWellConsultationsState
    extends State<LiveWellConsultations> {
  ...
  Future<bool> getConsultations(
    ...
    try {
      ...
      await Provider.of<GetConsultation>(context, listen: false)
          .getConsultation("userId=$expertId",
          currentPage.toString(),"liveWell");
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    ...
                    //       userID: consultationData.user![0]["_id"],
