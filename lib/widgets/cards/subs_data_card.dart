...
class SubsDataCard extends StatelessWidget {
  final Session session;
  const SubsDataCard({Key? key, required this.session}) : super(key: key);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    session.data["status"] == "stored"
                        ? InkWell(
                            onTap: validateVideoCall()
                                ? () {
